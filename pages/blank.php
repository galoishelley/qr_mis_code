...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               <div class="table-responsive">
									<table class="table table-bordered" id="tb_roles" data-bind="visible: true">
										<thead>
											<tr> 
										...
										<!-- Table Head -->
										<tbody data-bind="foreach: cList">
												<tr>
														<td>
															<input id="chk_list" type="checkbox"/>
														<!--
														...
														<td><span data-bind="text: vRoleID"></span></td>
														<td data-bind="text: vRoleName"></td>
														<td data-bind="text: vNote"></td>
														<td><img src=../images/info.gif> <img src=../images/update.gif></td>
												</tr>
										</tbody> 
						<!-- Table Body -->
					</table>
    ...
    <script src="../dist/js/sb-admin-2.js"></script>
		...
		<script src="../js/modelRoles.js"></script>
		<script src="../js/rolesInfo.js"></script>
